...
export default function Problems() {
  ...
  return (
    <section className="relative py-24 bg-bg-dark overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full bg-brand-blue/5 blur-[100px] pointer-events-none" />
          ...
          {problems.map((prob, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative flex flex-col justify-between rounded-2xl border border-white/5 bg-surface-dark p-8 transition-all hover:border-brand-blue/20 group"
              >
                ...
                <div className="absolute top-0 right-0 h-16 w-16 overflow-hidden pointer-events-none rounded-tr-2xl">
                  <div className="absolute top-[-10px] right-[-10px] h-6 w-[80px] rotate-45 bg-brand-blue/5 border-b border-brand-blue/10" />
                </div>

                <div>
                  <div className="inline-flex p-3 rounded-xl bg-brand-blue/5 border border-brand-blue/10 text-brand-blue-light mb-6 transition-transform group-hover:scale-105">
                ...
                <div className="mt-8 pt-6 border-t border-white/5 flex items-center justify-between">
                  <span className="text-xs font-semibold uppercase tracking-wider text-brand-blue-light">
                    {prob.leakRate}
                  </span>
                </div>
              </motion.div>
